...
def main(
    ...
    max_num_steps = np.inf  # (20000 / 32) * num_epochs
    # min_num_steps = 1
    ...
    scores['model_idx'] = 0
    model_groups = ['feedback', 'resnet', 'unet']
    ...
    keep_groups = np.where(~np.in1d(model_groups, 'feedback'))[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help='Number of epochs for calculating TTA.')
    parser.add_argument(
        '--port_fwd',
        dest='port_fwd',
        action='store_true',
