...
from layers.recurrent import mult_constrained_h_td_fgru as hgru
...
def build_model(data_tensor, reuse, training, output_shape):
    ...
    with tf.variable_scope('cnn', reuse=reuse):
        ...
        layer_hgru = hgru.hGRU(
            ...
            strides=[1, 1, 1, 1],
            hgru_ids={'h1': 16, 'h2': 48, 'h3': 96, 'fb2': 64, 'fb1': 16},  # hGRU labels and channels
            hgru_idx={'h1': 0, 'h2': 1, 'h3': 2, 'fb2': 3, 'fb1': 4},
            padding='SAME',
            aux={
                'readout': 'fb',
                'intermediate_ff': [48, 96],  # Add one more layer w/ either 36 or 72 channels
